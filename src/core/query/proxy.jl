...
# for a single resonance group.
function evalclrgbackend(
    qs::Vector{Vector{Function}},
    i::Integer,
    k::Integer,
    u_rad::T,
...
function evalclrg(u_rad::T, i::Integer, k::Integer, B::MoleculeType{T,SST,CLOperationRange{T}})::Complex{T} where {T <: Real, SST}

    return evalclrgbackend(B.qs, i, k, u_rad, B.ss_params)
end
